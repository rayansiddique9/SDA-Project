...
public class editUniDept extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_uni_dept);

        currentUserUni cu = currentUserUni.getInstance(obj);
        obj = cu.getU();

        list = new ArrayList<>();
        obj.getDeptsUni(editUniDept.this, obj.getName(), list);
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent in = new Intent(editUniDept.this, editUniDept2.class);
