...
public class activity_university_profile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView _name = findViewById(R.id.namee);
        //TextView _lName = findViewById(R.id.lastname);
        //TextView _cgpa = findViewById(R.id.CGPA);
        TextView _loc = findViewById(R.id.Location);
        TextView _longi = findViewById(R.id.longitudee);
        TextView _lati = findViewById(R.id.latitudee);
        TextView _phone = findViewById(R.id.phonee);
        TextView _rank = findViewById(R.id.Rankingg);
        ...
        if (connection != null) {
            ...
            try {
                ...
                CallableStatement callableStatement = connection.prepareCall("{call viewUniProfile(?)}");
                //passing parameters
                callableStatement.setInt("uid",6);
                ResultSet result = callableStatement.executeQuery();
                ...
                while(result.next()){
                    ...
                    _name.setText(result.getString("name"));
                    _lati.setText(result.getString("latitude"));
                    _longi.setText(result.getString("longitude"));
                    _phone.setText(result.getString("phone"));
                    _rank.setText(result.getString("ranking"));
