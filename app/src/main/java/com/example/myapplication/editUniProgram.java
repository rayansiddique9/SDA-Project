...
public class editUniProgram extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_uni_program);

        currentUserUni cu = currentUserUni.getInstance(obj);
        obj = cu.getU();

        list = new ArrayList<>();
        obj.getDeptsUni(editUniProgram.this, obj.getName(), list);
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(list.size() != 0) {
                    Intent in = new Intent(editUniProgram.this, editUniProgram2.class);
                    in.putExtra("dname", item);
                    startActivity(in);
                }
                else
                {
                    Toast.makeText(editUniProgram.this, "No department avalaible to select", Toast.LENGTH_SHORT).show();
                }
            }
        });
